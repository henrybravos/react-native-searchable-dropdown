...
export default class SearchableDropDown extends Component {
  ...
  searchedItems = searchedText => {
    ...
    const onTextChange = this.props.onTextChange || this.props.textInputProps && (this.props.textInputProps.onTextChange || this.props.textInputProps.onChangeText) || this.props.onChangeText;
